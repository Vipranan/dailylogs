...
export interface InitOutput {
  ...
  readonly awarenesswasm_getAllStates: (a: number, b: number) => void;
  readonly awarenesswasm_getState: (a: number, b: number, c: number) => void;
  ...
  readonly awarenesswasm_new: (a: number, b: number, c: number) => void;
  ...
  readonly cursor_pos: (a: number, b: number) => void;
  ...
  readonly ephemeralstorewasm_apply: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly ephemeralstorewasm_getAllStates: (a: number, b: number) => void;
  ...
  readonly lorocounter_getShallowValue: (a: number, b: number) => void;
  ...
  readonly lorodoc_frontiers: (a: number, b: number) => void;
  ...
  readonly lorodoc_oplogFrontiers: (a: number, b: number) => void;
  ...
  readonly lorodoc_shallowSinceFrontiers: (a: number, b: number) => void;
  ...
  readonly lorodoc_subscribeJsonpath: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly lorolist_getIdAt: (a: number, b: number, c: number) => void;
  readonly lorolist_getShallowValue: (a: number) => number;
  ...
  readonly lorotext_convertPos: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  ...
  readonly lorotext_sliceDelta: (a: number, b: number, c: number, d: number) => void;
  readonly lorotext_sliceDeltaUtf8: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly lorotext_toDelta: (a: number, b: number) => void;
  ...
  readonly lorotreenode_creationId: (a: number, b: number) => void;
  ...
  readonly lorotreenode_getLastMoveId: (a: number, b: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfe8a91975f82eb31: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9dca5105e176ced8: (a: number, b: number) => void;
